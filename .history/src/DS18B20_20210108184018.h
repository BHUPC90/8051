...
{
    uchar u1, u2 , u3 , u4 , u5 , u6 , u7 , u8;
    int_ds18b20();  //初始化，复位并获取应答信号
    Write_DS18B20(0xf0);  //跳过ROM
    u1 = Read_DS18B20();  //读取8位
    u2 = Read_DS18B20();  //读取8位
    u3 = Read_DS18B20();  //读取8位
    u4 = Read_DS18B20();  //读取8位
    u5 = Read_DS18B20();  //读取8位
    u6 = Read_DS18B20();  //读取8位
    u7 = Read_DS18B20();  //读取8位
    u8 = Read_DS18B20();  //读取8位
}
