...
void DS18B20_Read_id()
{
    ...
    id_u2 = Read_DS18B20();  //读取8位
    id_u3 = Read_DS18B20();  //读取8位
    id_u4 = Read_DS18B20();  //读取8位
    id_u5 = Read_DS18B20();  //读取8位
    id_u6 = Read_DS18B20();  //读取8位
    id_u7 = Read_DS18B20();  //读取8位
    id_u8 = Read_DS18B20();  //读取8位
}
