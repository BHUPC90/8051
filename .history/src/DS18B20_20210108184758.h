...
void DS18B20_Read_id()
{
    ...
    ds_id[0] = Read_DS18B20(); //读取8位
    ds_id[1] = Read_DS18B20(); //读取8位
    ds_id[2] = Read_DS18B20(); //读取8位
    ds_id[3] = Read_DS18B20(); //读取8位
    ds_id[4] = Read_DS18B20(); //读取8位
    ds_id[5] = Read_DS18B20(); //读取8位
    ds_id[6] = Read_DS18B20(); //读取8位
    ds_id[7] = Read_DS18B20(); //读取8位
}
