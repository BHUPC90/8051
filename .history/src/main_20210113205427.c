...
void change_time(int mmod)
{
    ...
    case 0: //年
        ...
        break;
    case 1:
        temptime = (time[4] / 16) * 10 + (time[4] & 0x0f);
        if (mmod)
            temptime++;
        else
            temptime--;
        ...
        break;
    case 2:
        temptime = (time[3] / 16) * 10 + (time[3] & 0x0f);
        if (mmod)
            temptime++;
        else
            temptime--;
        ...
        break;
    case 3:
        temptime = (time[2] / 16) * 10 + (time[2] & 0x0f);
        if (mmod)
            temptime++;
        else
            temptime--;
        ...
        break;
    case 4:
        temptime = (time[1] / 16) * 10 + (time[1] & 0x0f);
        if (mmod)
            temptime++;
        else
            temptime--;
        ...
        break;
    case 5:
        temptime = (time[0] / 16) * 10 + (time[0] & 0x0f);
        if (mmod)
            temptime++;
        else
            temptime--;
