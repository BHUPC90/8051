...
void lcd_12864_len_text(int len,uchar *data1)
{
    ...
    case 4:
        ...
        break;
    case 5:
        lcd_12864_write_com(0xA0); //第4行
        break;
    case 6:
        lcd_12864_write_com(0xB0); //第4行
        break;
    case 7:
        lcd_12864_write_com(0xA8); //第4行
        break;
    case 8:
        lcd_12864_write_com(0xB8); //第4行
        break;
    default:
        break;
    }
...
void photodisplay(uchar x, uchar y, uchar width) 
{
    ...
    lcd_12864_write_com(0x34); //写数据时,关闭图形显示,且打开扩展指令集
    for (i = 0; i < 16; i++)
    {
        lcd_12864_write_com(0x80 + (y << 4) + i);
        lcd_12864_write_com(0x80 + flag + x);
        for (j = 0; j < width; j++)
        {
            lcd_12864_write_data(0xff);
            lcd_12864_write_data(0xff);
        }
        delay(1);
    }
